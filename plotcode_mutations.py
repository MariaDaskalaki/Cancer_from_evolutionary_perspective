...
with open("Frequencies_mutations.txt",'r') as f:
    ...
    df.plot(figsize=(10,6), xticks=range(0,500,100)).legend(title='', bbox_to_anchor=(1, 1))
    ...
    #print(df_new)
    df_new.plot(figsize=(10,6), xticks=range(0, 500,100)).legend(title='', bbox_to_anchor=(1, 1))
